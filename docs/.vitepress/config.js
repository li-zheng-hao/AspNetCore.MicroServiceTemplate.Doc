export default {
    // base: '/AspNetCore.MicroServiceTemplate/docs',
    title: 'AspNetCore.MicroServiceTemplate',
    description: 'Asp.Net Core Webapi项目快速启动模板',
    themeConfig: {
        siteTitle: 'AspNetCore.MicroServiceTemplate',
        logo:'/logo.png',
        footer: {
        ...
        nav: [
            ...
            { text: '个人博客', link: 'https://www.lizhenghao.site',target:"blank" },
          ],
          socialLinks: [
            { icon: 'github', link: 'https://github.com/li-zheng-hao/AspNetCore.MicroServiceTemplate' },
